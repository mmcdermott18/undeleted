// variables to change
let fName = 'comp12-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [690, 483, 483, 483, 483]; // amout of files in each folder with the final fake 10 image folder
