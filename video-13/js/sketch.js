// variables to change
let fName = 'comp13-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [336, 327, 333, 328, 328]; // amout of files in each folder with the final fake 10 image folder
