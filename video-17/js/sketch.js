// variables to change
let fName = 'comp17-' // phone identifier name for video export
let folderAmount = 4; // amount of folders
let length = 5; // video duration in minutes
let images0 = []; // array of images, one for each folder + one at the end with 10 images
let images1 = [];
let images2 = [];
let images3 = [];
let folderValues = [301, 300, 333, 333]; // amout of files in each folder with the final fake 10 image folder
let currentArray = [images0, images1, images2, images3]; // array of image arrays
let currentFolder = ["images-0", "images-1", "images-2", "images-3"]; // array of folder names
