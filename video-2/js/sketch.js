// variables to change
let fName = 'comp2-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [335, 307, 309, 301, 301]; // amout of files in each folder with the final fake 10 image folder
