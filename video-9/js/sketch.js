// variables to change
let fName = 'comp9-' // phone identifier name for video export
...
let images6 = [];
let images7 = [];
let folderValues = [78, 78, 46, 121, 121, 121, 121, 121]; // amout of files in each folder with the final fake 10 image folder
