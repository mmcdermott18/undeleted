// variables to change
let fName = 'comp5-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [322, 300, 300, 300, 300]; // amout of files in each folder with the final fake 10 image folder
