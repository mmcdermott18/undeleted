// variables to change
let fName = 'comp3-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [301, 301, 307, 318, 318]; // amout of files in each folder with the final fake 10 image folder
