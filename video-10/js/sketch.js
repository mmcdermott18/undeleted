// variables to change
let fName = 'comp10-' // phone identifier name for video export
...
let images2 = [];
let images3 = [];
let folderValues = [300, 300, 300, 300]; // amout of files in each folder with the final fake 10 image folder
