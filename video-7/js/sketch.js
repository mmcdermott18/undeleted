// variables to change
let fName = 'comp7-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [300, 300, 300, 1393, 1393]; // amout of files in each folder with the final fake 10 image folder
