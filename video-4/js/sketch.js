// variables to change
let fName = 'comp4-' // phone identifier name for video export
...
let images3 = [];
let images4 = [];
let folderValues = [368, 833, 704, 300, 300]; // amout of files in each folder with the final fake 10 image folder
